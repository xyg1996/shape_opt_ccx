...
# Default start model:
self.start_model = 'F:/WORK/APP_dev/shape_opt/ASTERSTUDY/lib/python3.6/site-packages/asterstudy/gui/shape_opt/examples/simple_test.inp'
