	...
	<Keyword name='*STEP'>
		...
		<Group name='Analysis type'>
			...
			<Keyword name='*SENSITIVITY'>
				...
				<Keyword name='*DESIGN RESPONSE' from_new_line='1'>
				    <Argument form='QLineEdit' name='NAME'/>
					<!-- <Argument form='QComboBox' name='TYPE'>STRESS|EIGENFREQUENCY|MASS|STRAIN ENERGY</Argument> -->
					<Argument form='QCheckBox' name='STRESS'/>
					<Argument form='QCheckBox' name='EIGENFREQUENCY'/>
					<Argument form='QCheckBox' name='MASS'/>
					<Argument form='QCheckBox' name='STRAIN ENERGY'/>
					<!-- <Argument form='QCheckBox' name='DISPLACEMENT'/>
					<Argument form='QCheckBox' name='EIGENFREQUENCY'/>
					<Argument form='QCheckBox' name='GREEN'/>
					<Argument form='QCheckBox' name='MASS'/>
			...
			<Keyword name='*FEASIBLE DIRECTION'>
				...
				<Keyword name='*OBJECTIVE' required='1' >
					<Argument form='QComboBox' name='TARGET'>MIN|MAX|</Argument>
				</Keyword>
			</Keyword>
			<Keyword name='*STATIC'>
				<Argument form='QComboBox' name='SOLVER'>SPOOLES|PARDISO|SGI|TAUCS|ITERATIVE CHOLESKY|ITERATIVE SCALING</Argument>
