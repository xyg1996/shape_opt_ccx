...
class Path:
    ...
    def __init__(self):
        ...
        self.default_inp = os.path.join(self.examples,'connecting_rod-ccx.inp')
        self.default_med = os.path.join(self.examples,'connecting_rod-ccx.med')
        ...
        self.opt_run = os.path.join(self.config, 'ccx-shape.py')

        self.utils = os.path.join(self.app_home_dir, 'utils')
        self.env = os.path.join(self.utils,'env.sh')
        self.ccx2paraview = os.path.join(self.utils,'ccx-2-paraview.py')
        self.ccx2paraviewOpt = os.path.join(self.utils,'ccx-2-paraview-opt.py')
        self.ccx2paraview_run = os.path.join(self.utils,'ccx-2-paraview.sh')
        self.unset_python = os.path.join(self.utils,'unset_python.sh')
        self.path_paraview = "/share/simforge_share/open-source/Paraview/ParaView-5.10.0-RC2-MPI-Linux-Python3.9-x86_64/bin/paraview"
