...
class Path:
    ...
    def __init__(self):
        ...
        # Linux
            ...
            self.users = os.system('whoami') # user id
        ...
        self.settings_path = os.path.join(self.config,self.users)
        self.settings = os.path.join(self.settings_path, 'Settings_' + self.op_sys + '.py')
